...
swfobject.embedSWF("flash/menu_candidat.swf","menu_anim","550","90","9.0.0","include/swfobject/expressInstall.swf");
</script>
</head>
...
<table id="Tableau_01" width="811" height="871" border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<tr>
		<td background="images/_index_02.jpg" width="811" height="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="txt_1"><b>CANDIDAT</b></span> | <a href="Recruteur.jsp" class="txt_2"><b>RECRUTEUR</b></a> | <a href="admin.jsp" class="txt_2"><b>ADMIN</b></a></td>
	</tr>
	<tr>
            ...
            <div id="carrousel">
                ...
                <div id="slide2" class="slide">
                    ...
                    <td width="279" height="181" bgcolor="#FFFFFF">
                    	<%@include file="include/pages/identification/login_candidat.jsp" %> 
                    </td>
                    <td bgcolor="#FFFFFF">
	...
	<tr>
		<td background="images/_index_04.jpg" width="811" height="138">
			<%@include file="include/pages/rechercher/rechercher.jsp" %></td>
	</tr>
	<tr>
		<td width="811" height="470" valign="top" background="images/_index_05.jpg">
			<div id="contenu">
        	<%@include file="include/fonctions/redirectionCan.jsp" %> 
        </div></td>
	</tr>
	<tr>
		<td>
